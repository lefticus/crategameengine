...
{
  class memoryworld : public game_personality::personality::world
  {
    public:
      memoryworld(const boost::function<void (mvc::logger::log_level, const std::string &, const std::string &)> 
                  &t_logger);
