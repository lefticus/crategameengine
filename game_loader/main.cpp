...
int main(int, char **)
{
  ...
  game_worlds::memoryworld w(boost::bind(&mvc::logger::log, &l, _1, _2, _3));
  game_viewers::viewstub v(boost::bind(&mvc::logger::log, &l, _1, _2, _3));
  game_engine::engineimpl e(boost::bind(&mvc::logger::log, &l, _1, _2, _3), v, w);
